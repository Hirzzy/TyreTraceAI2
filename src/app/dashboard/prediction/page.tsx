...
// src/app/dashboard/prediction/page.tsx
"use client"
        ...
        <CardContent>
          {donnees.length === 0 ? (
            <div className="text-center py-10">
              ...
              <p className="text-muted-foreground">Veuillez saisir des données via la page <Button variant="link" onClick={() => router.push('/dashboard/remplissage')} className="p-0 h-auto">'Nouvelle inspection'</Button> pour afficher les prédictions.</p>
            </div>
          ) : (
